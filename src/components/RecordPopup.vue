<template>
  <Modal :is-open="recordPopupOpen" @on-close="onClose">
    <div class="mb-4 text-center text-lg text-white">遊戲記錄</div>
    <div class="space-y-2">
      <!-- Record Items -->
      <div
    ...
    <button class="button-3d mt-4 w-full rounded-lg bg-pink-600 px-4 py-2 text-white" @click="onClose">關閉</button>
  </Modal>
</template>
